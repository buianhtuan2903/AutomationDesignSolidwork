...
namespace DieSetTool
{
    class HType
    {
        ...
        public string Molddim;

        public void getdata( String combobox1data, String combobox2data, String combobox3data, String combobox4data, String combobox5data, String combobox6data, String combobox7data, String TB1data, String TB2data, String TB3data, String TB4data)
        {
            MainWindow run = new MainWindow();
            Molddim = (Convert.ToString(combobox1data));
            ...
            l_PBC = (Convert.ToDouble(TB4data)) / 1000;
        }
        public void HTypeCode()
        {
            ...
            double x_mold = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 2, false)) / 1000;
            double y_mold = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 3, false)) / 1000;

            double T = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 5, false)) / 1000;
            double R = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 6, false)) / 1000;
            double E = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 7, false)) / 1000;
            double F = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 8, false)) / 1000;
            double x_EF = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 9, false)) / 1000;
            double x_C = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 10, false)) / 1000;
            double L = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 11, false)) / 1000;

            double x_GP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 12, false)) / 2000;
            double y_GP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 13, false)) / 2000;
            double y1_GP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 14, false)) / 1000;
            double d_GP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 15, false)) / 1000;
            double head_GP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 16, false)) / 1000;
            double hhead_GP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 17, false)) / 1000;

            double d1_GB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 18, false)) / 1000;
            double head_GB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 19, false)) / 1000;
            double hhead_GB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 20, false)) / 1000;

            double x_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 21, false)) / 2000;
            double y_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 22, false)) / 2000;
            double y1_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 23, false)) / 1000;
            double d_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 24, false)) / 1000;
            double head_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 25, false)) / 1000;
            double hhead_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 26, false)) / 1000;
            double head2_SPP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 27, false)) / 1000;

            double x_RP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 28, false)) / 2000;
            double y_RP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 29, false)) / 2000;
            double d_RP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 30, false)) / 1000;
            double head_RP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 31, false)) / 1000;
            double hhead_RP = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 32, false)) / 1000;

            double spacer = 0.005;

            double x_CB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 33, false)) / 2000;
            double y_CB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 34, false)) / 2000;
            double m_CB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 35, false));
            ...
            double x_EB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 36, false)) / 2000;
            double y_EB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 37, false)) / 2000;
            double l1_EB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 39, false)) / 1000;
            double m_EB = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 38, false));
            ...
            double d_SPC = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 40, false)) / 1000;
            double t_SPC = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 42, false)) / 1000;
            double m_SPC = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 43, false));
            ...
            double l2_SPC = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18" ], 44, false)) / 1000;
            ...
            double x_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 45, false)) / 2000;
            double y_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 46, false)) / 2000;
            double d_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 47, false)) / 1000;
            double l_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 48, false)) / 1000;
            double head_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 49, false)) / 1000;
            double f_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 50, false)) / 1000;
            double D_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 51, false)) / 1000;
            double m_PL = Convert.ToDouble(xlWS.Application.WorksheetFunction.VLookup(Molddim, xlWS.Range["A4:AZ18"], 52, false)) ;
            ...
            // Create Hole SPP
            boolstatus = swDoc.Extension.SelectByRay(-x_SPP, -y_SPP, 0, -x_SPP, -y_SPP, -1, 0.01, 2, false, 0, 0);
            ...
            // Create hole Puller bolt
            boolstatus = swDoc.Extension.SelectByRay(-x_PL, -y_PL, 0, -x_PL, -y_PL, -1, 0.01, 2, false, 0, 0);
            swHoleFeature = ((Feature)(swDoc.FeatureManager.HoleWizard5(0, 8, 139, "M5", 0, d_PL+0.001, T, -1, D_PL + 0.002, T - l_PL + 0.01, 0, 1, 2.05948851735331, 0, 0, -1, -1, -1, -1, -1, "", false, true, true, true, true, false)));
            swSketchFeature = swHoleFeature.GetFirstSubFeature();
            swDoc.ClearSelection2(true);
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut23 = null;
            SketchCut23 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (m_PL / 2000) + 0.0005)));
            SketchCut23 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (m_PL / 2000) + 0.0005)));
            SketchCut23 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (m_PL / 2000) + 0.0005)));
            SketchCut23 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (m_PL / 2000) + 0.0005)));

            Feature Cut23 = null;
            Cut23 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, R, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -T, false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);

            // Create Hole HGB

            boolstatus = swDoc.Extension.SelectByRay(x_mold, y_SPP, -(T + (R / 2)), -1, 0, 0, 0.01, 2, false, 0, 0);
            swHoleFeature = ((Feature)(swDoc.FeatureManager.HoleWizard5(0, 8, 139, "M5", 0, m_HGB - 0.001, 0.018, -1, m_HGB, 0.015, 0, 1, 2.05948851735331, 0, 0, -1, -1, -1, -1, -1, "", false, true, true, true, true, false)));
            swSketchFeature = swHoleFeature.GetFirstSubFeature();
            swDoc.ClearSelection2(true);

            boolstatus = swDoc.Extension.SelectByRay(x_mold, -y1_SPP, -(T + (R / 2)), -1, 0, 0, 0.01, 2, false, 0, 0);
            swHoleFeature = ((Feature)(swDoc.FeatureManager.HoleWizard5(0, 8, 139, "M5", 0, m_HGB - 0.001, 0.018, -1, m_HGB, 0.015, 0, 1, 2.05948851735331, 0, 0, -1, -1, -1, -1, -1, "", false, true, true, true, true, false)));
            swSketchFeature = swHoleFeature.GetFirstSubFeature();
            swDoc.ClearSelection2(true);
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut33 = null;
            SketchCut33 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (d_PL / 2) + 0.0005 )));
            SketchCut33 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (d_PL / 2) + 0.0005)));
            SketchCut33 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (d_PL / 2) + 0.0005)));
            SketchCut33 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (d_PL / 2) + 0.0005)));
            
            Feature Cut33 = null;
            Cut33 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, A, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            if (S != 0)
            {
                ...
                boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
                swDoc.ClearSelection2(true);
                SketchSegment SketchCut43 = null;
                SketchCut43 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
                SketchCut43 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));
                SketchCut43 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
                SketchCut43 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));

                Feature Cut43 = null;
                Cut43 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, S, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A), false, false)));
                swDoc.SelectionManager.EnableContourSelection = false;
                swDoc.ClearSelection2(true);

                // Create Hole HGB
                boolstatus = swDoc.Extension.SelectByRay(x_mold, y_GP, -(T + R + A + (S / 2)), -1, 0, 0, 0.01, 2, false, 0, 0);
                swHoleFeature = ((Feature)(swDoc.FeatureManager.HoleWizard5(0, 8, 139, "M5", 0, m_HGB - 0.001, 0.033, -1, m_HGB, 0.03, 0, 1, 2.05948851735331, 0, 0, -1, -1, -1, -1, -1, "", false, true, true, true, true, false)));
                swSketchFeature = swHoleFeature.GetFirstSubFeature();
                swDoc.ClearSelection2(true);

                boolstatus = swDoc.Extension.SelectByRay(x_mold, -y1_GP, -(T + R + A + (S / 2)), -1, 0, 0, 0.01, 2, false, 0, 0);
                swHoleFeature = ((Feature)(swDoc.FeatureManager.HoleWizard5(0, 8, 139, "M5", 0, m_HGB - 0.001, 0.033, -1, m_HGB, 0.03, 0, 1, 2.05948851735331, 0, 0, -1, -1, -1, -1, -1, "", false, true, true, true, true, false)));
                swSketchFeature = swHoleFeature.GetFirstSubFeature();
                swDoc.ClearSelection2(true);
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut54 = null;
            SketchCut54 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut54 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut54 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut54 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));

            Feature Cut54 = null;
            Cut54 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, B, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            if (U != 0)
            {
                ...
                boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
                swDoc.ClearSelection2(true);
                SketchSegment SketchCut63 = null;
                SketchCut63 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
                SketchCut63 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));
                SketchCut63 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
                SketchCut63 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));

                Feature Cut63 = null;
                Cut63 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, U, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S + B), false, false)));
                swDoc.SelectionManager.EnableContourSelection = false;
                swDoc.ClearSelection2(true);
            }
            // Save
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut73 = null;

            SketchCut73 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut73 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));

            Feature Cut73 = null;
            Cut73 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, C, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S + B + U), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut83 = null;
            SketchCut83 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut83 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));
 
            Feature Cut83 = null;
            Cut83 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, C, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S + B + U), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            SketchCut93 = ((swDoc.SketchManager.CreateCircleByRadius(-x_EB, y_EB, 0, m_EB / 2000)));

            SketchCut93 = (swDoc.SketchManager.CreateCircleByRadius(x_EB, -y_EB, 0, m_EB / 2000));

            SketchCut93 = ((SketchSegment)(swDoc.SketchManager.CreateCircle(x_EB, y_EB, 0, x_EB - (m_EB / 2000), y_EB, 0)));
            SketchCut93 = ((SketchSegment)(swDoc.SketchManager.CreateCircle(-x_EB, -y_EB, 0, (-x_EB) - (m_EB / 2000), -y_EB, 0)));

            Feature Cut93 = null;
            Cut93 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, E, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S + B + U + C - spacer - E - F), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut113 = null;
            SketchCut113 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut113 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(-x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut113 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, (D_PL / 2) + 0.001)));
            SketchCut113 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, -y_PL, 0, (D_PL / 2) + 0.001)));

            Feature Cut113 = null;
            Cut113 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, L, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S + B + U + C), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            swDoc.ClearSelection2(true);
            SketchSegment SketchCut114 = null;
            SketchCut114 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(0, 0, 0, 0.017)));

            Feature Cut114 = null;
            Cut114 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, L, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A + S + B + U + C), false, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);
            ...
            Feature Pattern16;
            Pattern16 = ((Feature)(swDoc.FeatureManager.FeatureLinearPattern5(3, y_CB, 2, x_CB * 2, true, true, "NULL", "NULL", false, false, false, false, false, false, true, true, false, false, 0, 0, false, false)));
            swDoc.ClearSelection2(true);
            ...
            Sketch21 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, d_PL / 2)));
            Feature Extrude21 = null;
            Extrude21 = ((Feature)(swDoc.FeatureManager.FeatureExtrusion2(true, false, false, 0, 0, l_PL, 0, false, false, false, false, 0, 0, false, false, false, false, true, true, true, 3, -T, false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);

            // Create head
            SketchSegment Sketch211 = null;
            Sketch211 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, D_PL / 2)));
            Feature Extrude211 = null;
            Extrude211 = ((Feature)(swDoc.FeatureManager.FeatureExtrusion2(true, false, false, 0, 0, head_PL, 0, false, false, false, false, 0, 0, false, false, false, false, true, true, true, 3, -(T - l_PL), false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);

            // Create M
            SketchSegment Sketch212 = null;
            Sketch212 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, m_PL / 2000)));
            Feature Extrude212 = null;
            Extrude212 = ((Feature)(swDoc.FeatureManager.FeatureExtrusion2(true, false, true, 0, 0, f_PL, 0, false, false, false, false, 0, 0, false, false, false, false, true, true, true, 3, -T , false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);

            // Save
            boolstatus = swDoc.SaveAs(SaveLocation + "\\M-PBC.sldprt");
            // Close Document
            swDoc = null;
            swApp.CloseDoc("M-PBC.sldprt");
            swDoc = swApp.ActiveDoc;

            // Linear Pattern
            boolstatus = swDoc.Extension.SelectByID2("Top Plane", "PLANE", 0, 0, 0, true, 2, null, 0);
            boolstatus = swDoc.Extension.SelectByID2("Right Plane", "PLANE", 0, 0, 0, true, 4, null, 0);
            boolstatus = swDoc.Extension.SelectByID2("M-PBC-1@Assem1", "COMPONENT", 0, 0, 0, true, 1, null, 0);


            Feature Pattern21;
            Pattern21 = ((Feature)(swDoc.FeatureManager.FeatureLinearPattern5(2, y_PL * 2, 2, x_PL * 2, true, true, "NULL", "NULL", false, false, false, false, false, false, true, true, false, false, 0, 0, false, false)));
            swDoc.ClearSelection2(true);

            // Insert Puller Bolt PBA
            object Plane22 = null;
            Component2 swComponent22;
            longstatus = swAssembly.InsertNewVirtualPart(Plane22, out swComponent22);
            boolstatus = swDoc.Extension.SelectByID2("Part22^Assem1-1@Assem1", "COMPONENT", 0, 0, 0, false, 0, null, 0);
            swAssembly.OpenCompFile();

            // Open
            swDoc = swApp.OpenDoc6("Part22^Assem1.sldprt", 1, 0, "", longstatus, longwarnings);
            swDoc = swApp.ActiveDoc;

            swApp.ActivateDoc2("Part22^Assem1.sldprt", false, longstatus);
            swDoc = swApp.ActiveDoc;
            swDoc.ClearSelection2(true);
            swDoc.SketchManager.InsertSketch(true);
            boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
            ...
            Sketch22 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, d_PL / 2)));
            Feature Extrude22 = null;
            Extrude22 = ((Feature)(swDoc.FeatureManager.FeatureExtrusion2(true, false, true, 0, 0, l_PBC, 0, false, false, false, false, 0, 0, false, false, false, false, true, true, true, 3, -(T + R), false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);

            SketchSegment Sketch221 = null;
            Sketch221 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_PL, y_PL, 0, D_PL / 2)));
            Feature Extrude221 = null;
            Extrude221 = ((Feature)(swDoc.FeatureManager.FeatureExtrusion2(true, false, true, 0, 0, head_PL, 0, false, false, false, false, 0, 0, false, false, false, false, true, true, true, 3, -(T + R + l_PBC), false)));
            swDoc.SelectionManager.EnableContourSelection = false;
            swDoc.ClearSelection2(true);

            // Create hole M12
            boolstatus = swDoc.Extension.SelectByRay(x_PL, y_PL, -(T + R), x_PL, y_PL, -(T + R + 1), 0.01, 2, false, 0, 0);
            swHoleFeature = ((Feature)(swDoc.FeatureManager.HoleWizard5(0, 8, 139, "M5", 0, 0.0104, 0.028, -1, m_PL / 1000, 0.025, 0, 1, 2.05948851735331, 0, 0, 0, 0, 0, 0, 0, "", false, true, true, true, true, false)));
            swSketchFeature = swHoleFeature.GetFirstSubFeature();
            swDoc.ClearSelection2(true);

            // Save
            boolstatus = swDoc.SaveAs(SaveLocation + "\\M-PBA.sldprt");
            // Close Document
            swDoc = null;
            swApp.CloseDoc("M-PBA.sldprt");
            swDoc = swApp.ActiveDoc;

            // Linear Pattern
            boolstatus = swDoc.Extension.SelectByID2("Top Plane", "PLANE", 0, 0, 0, true, 2, null, 0);
            boolstatus = swDoc.Extension.SelectByID2("Right Plane", "PLANE", 0, 0, 0, true, 4, null, 0);
            boolstatus = swDoc.Extension.SelectByID2("M-PBA-1@Assem1", "COMPONENT", 0, 0, 0, true, 1, null, 0);


            Feature Pattern22;
            Pattern22 = ((Feature)(swDoc.FeatureManager.FeatureLinearPattern5(2, y_PL * 2, 2, x_PL * 2, true, true, "NULL", "NULL", false, false, false, false, false, false, true, true, false, false, 0, 0, false, false)));
            swDoc.ClearSelection2(true);
            ...
            {
                object Plane23 = null;
                Component2 swComponent23;
                longstatus = swAssembly.InsertNewVirtualPart(Plane23, out swComponent23);
                boolstatus = swDoc.Extension.SelectByID2("Part23^Assem1-1@Assem1", "COMPONENT", 0, 0, 0, false, 0, null, 0);
                swAssembly.OpenCompFile();

                // Open
                swDoc = swApp.OpenDoc6("Part23^Assem1.sldprt", 1, 0, "", longstatus, longwarnings);
                swDoc = swApp.ActiveDoc;

                swApp.ActivateDoc2("Part23^Assem1.sldprt", false, longstatus);
                swDoc = swApp.ActiveDoc;
                swDoc.ClearSelection2(true);
                swDoc.SketchManager.InsertSketch(true);
                boolstatus = swDoc.Extension.SelectByID2("Front Plane", "PLANE", 0, 0, 0, false, 0, null, 0);
                ...
                // Create Sketch - Extrude
                SketchSegment Sketch23 = null;
                Sketch23 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_GP, y_GP, 0, d1_GB / 2)));
                Feature Extrude23 = null;
                Extrude23 = ((Feature)(swDoc.FeatureManager.FeatureExtrusion2(true, false, true, 0, 0, S - 0.001, 0, false, false, false, false, 0, 0, false, false, false, false, true, true, true, 3, -(T + R + A) - 0.0005, false)));
                swDoc.SelectionManager.EnableContourSelection = false;
                swDoc.ClearSelection2(true);

                SketchSegment Sketch231 = null;
                Sketch231 = ((SketchSegment)(swDoc.SketchManager.CreateCircleByRadius(x_GP, y_GP, 0, d_GP / 2)));
                Feature Cut231 = null;
                Cut231 = ((Feature)(swDoc.FeatureManager.FeatureCut4(true, false, false, 0, 0, S - 0.001, 0, false, false, false, false, 0, 0, false, false, false, false, false, true, true, true, true, false, 3, -(T + R + A) - 0.0005, false, false)));
                swDoc.SelectionManager.EnableContourSelection = false;
                swDoc.ClearSelection2(true);
                // Save
                ...
                Feature Pattern23;
                Pattern23 = ((Feature)(swDoc.FeatureManager.FeatureLinearPattern5(2, y_GP * 2, 2, x_GP * 2, true, true, "NULL", "NULL", false, false, false, false, false, false, true, true, false, false, 0, 0, false, false)));
                swDoc.ClearSelection2(true);
                swDefinition = Pattern23.GetDefinition();

                swDefinition.SkippedItemArray = swSkippedPattern;

                boolstatus = Pattern23.ModifyDefinition(swDefinition, swDoc, null);
                swDoc.ClearSelection2(true);
                ...
                Feature Pattern231;
                Pattern231 = ((Feature)(swDoc.FeatureManager.FeatureLinearPattern5(2, y_GP + y1_GP, 0, 0, true, true, "NULL", "NULL", false, false, false, false, false, false, true, true, false, false, 0, 0, false, false)));
                swDoc.ClearSelection2(true);
            }
            // ---------------------------------------------------------
